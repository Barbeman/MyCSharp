...
namespace Yakovlev
{
    namespace Sum
    {
        class Program
        {
            ...
            {
                Console.WriteLine("Проверка GIT эйэй. Проверка ветвления 3. Посчитаем сумму введенных нечетных положительных чисел. Результат будет выведен на экран при вводе нуля.");
                int n = -10, sum = 0;
                string numbers = "";
                while (n != 0)
                {
